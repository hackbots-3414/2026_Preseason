...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    APTarget target = new APTarget(m_estimatedPose)
    ...
    public void setupSysId() {
        // Translation
        SmartDashboard.putData("Translation Quasistatic Forward",
                m_sysIdRoutineTranslation.quasistatic(Direction.kForward));
        SmartDashboard.putData("Translation Quasistatic Reverse",
